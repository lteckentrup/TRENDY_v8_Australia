...
for year in {2001..2018..1}; do
  ...
  for month in {01..12..1}; do
    cdo -b F64 monthsum MODIS_GPP_${year}_${month}.nc \
        MODIS_GPP_${year}_${month}_sum.nc
    cdo -b F64 remapycon,fine_grid.txt MODIS_GPP_${year}_${month}_sum.nc \
        MODIS_GPP_${year}_${month}_remapycon.nc
